    ...
    return (
        <div className="bg-gray-100 p-8">
            ...
            <div className="mb-4">
                ...
                <div className="border p-4 rounded-lg bg-white dark:bg-zinc-700">
                    <div className="mb-4">
                        <label htmlFor="restaurantName" className="block text-sm font-medium  text-zinc-700 dark:text-zinc-300">Restaurant name</label>
                        <input type="text" id="restaurantName" className="mt-1 block w-full px-3 py-2 border text-black border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 dark:focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 sm:text-sm" />
                    </div>
                    <div className="mb-4">
                        ...
                        <input type="text" id="restaurantAddress" className="mt-1 block w-full px-3 py-2 border  text-black border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 dark:focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 sm:text-sm" />
                    </div>
                    <div className="mb-4">
                        ...
                        <input type="text" id="restaurantLocality" placeholder="e.g. Sector 43, Gur..." className="mt-1 block w-full  text-black px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 dark:focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 sm:text-sm" />
                        <button className="mt-2 px-4 py-2 bg-blue-500 dark:bg-zinc-600 text-white rounded-md">Detect</button>
                    </div>
                </div>
            </div>
                ...
                <div className="border p-4 rounded-lg bg-white dark:bg-zinc-700">
                    <div className="mb-4">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                            <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-zinc-300 dark:border-zinc-600 bg-zinc-50 dark:bg-zinc-600 text-zinc-500 dark:text-zinc-300 text-sm">+91</span>
                        ...
                        <button className="mt-2 px-4 py-2 bg-blue-500 dark:bg-zinc-600 text-white rounded-md">Verify</button>
                    </div>
                </div>
            </div>
