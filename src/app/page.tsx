            ...
            <div>
              ...
              <div>
                <span className="text-gray-600 text-sm">
                  ...
                  boost your brand visibility by providing insights to improve
                  your business.
                </span>
              ...
              <div className="w-44 shadow-md bg-white rounded-lg ">
                <div className="flex flex-col justify-center items-center gap-y-2">
                  ...
                  <span className="px-2 text-gray-700 text-sm text-center">
                    Start taking orders online from millions of users near you
                    and deliver with Zomato...
                  </span>
            ...
            <div className="flex  flex-col justify-center items-center">
              ...
              {faqs && (
                <span className="text-black text-sm p-2 w-1/2">
                  this is an faq answer test bjwe wegjwegwe gjkewgnwegknewg wekn
                  we wenwegbwewebg weg wejgbwegwejgwe gejg eg ejgew gejg
                  egbewejgbwe answer test bjwe wegjwegwe gjkewgnwegknewg wekn we
                  wenwegbwewebg weg wejgbwegwejgwe gejg eg ejgew gejg
                  egbewejgbweanswer test bjwe wegjwegwe gjkewgnwegknewg wekn we
                  wenwegbwewebg weg wejgbwegwejgwe gejg eg ejgew gejg
                  egbewejgbwe
                </span>
              )}
