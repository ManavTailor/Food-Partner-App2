...
export default function SignupPage() {
  ...
  return (
    ...
    <div className=" flex items-center justify-center w-full py-20 text-center bg-[url('/Images/homeBG5.jpg')] bg-center bg-cover " >
      ...
      <h1 className="signup text-black text-xl flex items-start  w-full  font-semibold ">Sign Up</h1>
        ...
        <button
          ...
          className="p-2 border border-gray-300 rounded-lg mb-4 hover:bg-gray-500 focus:outline-none w-full focus:border-gray-600">Create Account</button>
        ...
        <hr />
          ...
          <span className="signup text-black flex items-start gap-2 w-full mt-5 ">Already have an account?<Link href="/login" className="text-rose-500">Login</Link></span>
      </div>
    </div>
